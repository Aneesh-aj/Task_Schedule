...
const Home = () => {
    ...
    return (
        <>
            <div className="w-full  h-auto flex flex-col items-center   background_color">
                <Nav />
                <div className="w-[90%]">
                    <Toolbar className=" h-[50%] ">
                        <Typography sx={{ flexDirection: 'column' }} className="w-[50%] h-full flex p-4  justify-center gap-3 animate-slideUp">
                            <button onClick={()=>navigate("/user/task")} className="w-[7rem] h-[2rem] bg-sky-500 rounded-md text-white shadow-md hover:bg-sky-400 hover:shadow-lg transition-all duration-150 delay-150 ">
                                Assingment
                            </button>
